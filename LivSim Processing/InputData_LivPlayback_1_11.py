...
SharingPartners = nump.loadtxt("C:/Users/kbui1993/Desktop/NewLivSimCode/Input/Input_SPartners2.txt")
...
PatientPlayback = nump.loadtxt("C:/Users/kbui1993/Desktop/NewLivSimCode/Input/Patients.txt")
print("Patients.txt loaded.")

#Organ Input Data
OrganPlayback = nump.loadtxt("C:/Users/kbui1993/Desktop/NewLivSimCode/Input/Donors.txt")
print("Donors.txt loaded.")

#Progession Input Data
ProgressionPlayback = nump.loadtxt("C:/Users/kbui1993/Desktop/NewLivSimCode/Input/Status.txt")
print("Status.txt loaded.")

#Relist Data
Relist = nump.loadtxt("C:/Users/kbui1993/Desktop/NewLivSimCode/Input/Input_Relist.txt")
print("Input_Relist.txt loaded.")

#Acceptance Model Data
AcceptanceModel = nump.loadtxt("C:/Users/kbui1993/Desktop/NewLivSimCode/Input/Input_Acceptance.txt")
print("Input_Acceptance.txt loaded.")

AcceptanceModelS1 = nump.loadtxt("C:/Users/kbui1993/Desktop/NewLivSimCode/Input/Input_Acceptance_Status1.txt")
print("Input_Acceptance_Status1.txt loaded.")

DSA_Avg_Times = nump.loadtxt("C:/Users/kbui1993/Desktop/NewLivSimCode/Input/DSA_AvgTimes.txt")
...
with open("C:/Users/kbui1993/Desktop/NewLivSimCode/Input/Donor_Accept.txt",'r') as inputf:
...
with open("C:/Users/kbui1993/Desktop/NewLivSimCode/Input/Patients_Accept.txt",'r') as inputf:
    reader = list(csv.reader(inputf, delimiter = '|'))
    Patients_Accept = []
    for row in reader:
...
if i_initial ==1:
    ...
    InitialList = nump.loadtxt("C:/Users/kbui1993/Desktop/NewLivSimCode/Input/Waitlist_matchmeld.txt")
